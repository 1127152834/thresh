/*
 ...
 Source Schema         : thresh_cloud_route
...
db.getCollection("blackList").insert([ {
    ...
    _class: "com.zhang.thresh.gateway.entity.BlackList"
} ]);
...
db.getCollection("rateLimitRule").insert([ {
    ...
    _class: "com.zhang.thresh.gateway.enhance.entity.RateLimitRule"
} ]);
...
db.getCollection("routeUser").insert([ {
    ...
    _class: "com.zhang.thresh.gateway.enhance.entity.RouteUser"
} ]);
db.getCollection("routeUser").insert([ {
