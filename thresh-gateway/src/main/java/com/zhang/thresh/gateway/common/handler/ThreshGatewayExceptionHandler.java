package com.zhang.thresh.gateway.common.handler;
 ...
 */
@Slf4j
public class ThreshGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public ThreshGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
