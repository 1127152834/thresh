...
import com.zhang.thresh.gateway.enhance.mapper.RouteLogMapper;
    ...
    private Query getQuery(RouteLog routeLog) {
        ...
        if (StringUtils.isNotBlank(routeLog.getCreateTimeFrom())
            ...
            criteria.andOperator(
                    Criteria.where(ThreshConstant.CREATE_TIME).gt(routeLog.getCreateTimeFrom()),
                    Criteria.where(ThreshConstant.CREATE_TIME).lt(routeLog.getCreateTimeTo())
            );
        }
