package com.zhang.thresh.auth.manager;

import com.zhang.thresh.auth.mapper.MenuMapper;
import com.zhang.thresh.auth.mapper.UserMapper;
import com.zhang.thresh.auth.mapper.UserRoleMapper;
...
public class UserManager {
    ...
    public SystemUser registUser(String username, String password) {
        ...
        // 注册用户角色 ID
        userRole.setRoleId(ThreshConstant.REGISTER_ROLE_ID);
