...
import com.zhang.thresh.auth.properties.ThreshValidateCodeProperties;
...
import com.zhang.thresh.common.core.entity.constant.ImageTypeConstant;
...
public class ValidateCodeServiceImpl implements ValidateCodeService {
    ...
    public void create(HttpServletRequest request, HttpServletResponse response) throws IOException, ValidateCodeException {
        ...
        ThreshValidateCodeProperties code = properties.getCode();
        setHeader(response, code.getType());

        Captcha captcha = createCaptcha(code);
        redisService.set(ThreshConstant.CODE_PREFIX + key, StringUtils.lowerCase(captcha.text()), code.getTime());
        captcha.out(response.getOutputStream());
    }

    @Override
    public void check(String key, String value) throws ValidateCodeException {
        Object codeInRedis = redisService.get(ThreshConstant.CODE_PREFIX + key);
    ...
    private Captcha createCaptcha(ThreshValidateCodeProperties code) {
