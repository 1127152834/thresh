package com.zhang.thresh.auth.translator;
...
public class ThreshWebResponseExceptionTranslator implements WebResponseExceptionTranslator {

    @Override
    public ResponseEntity<?> translate(Exception e) {
        ResponseEntity.BodyBuilder status = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR);
        ThreshResponse response = new ThreshResponse();
        String message = "认证失败";
        log.error(message, e);
