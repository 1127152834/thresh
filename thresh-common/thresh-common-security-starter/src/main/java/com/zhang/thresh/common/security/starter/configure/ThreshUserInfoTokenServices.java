 ...
 * @author MrZhang
 */
public class ThreshUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public ThreshUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
