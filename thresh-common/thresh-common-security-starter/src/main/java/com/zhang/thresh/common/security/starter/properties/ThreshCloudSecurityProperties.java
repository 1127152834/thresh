package com.zhang.thresh.common.security.starter.properties;
 ...
 * @author MrZhang
 */
@ConfigurationProperties(prefix = "thresh.cloud.security")
public class ThreshCloudSecurityProperties {
    ...
    public String toString() {
        return "ThreshCloudSecurityProperties{" +
                "enable=" + enable +
                ", authUri='" + authUri + '\'' +
                ", anonUris='" + anonUris + '\'' +
