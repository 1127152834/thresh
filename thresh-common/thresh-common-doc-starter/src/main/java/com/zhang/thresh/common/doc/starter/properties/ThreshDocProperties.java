package com.zhang.thresh.common.doc.starter.properties;
 ...
 * @author MrZhang
 */
@ConfigurationProperties(prefix = "thresh.doc")
public class ThreshDocProperties {
