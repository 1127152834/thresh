...
public abstract class FileUtil {
    ...
    public static void download(String filePath, String fileName, Boolean delete, HttpServletResponse response) throws Exception {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName=" + java.net.URLEncoder.encode(fileName, ThreshConstant.UTF8));
        response.setContentType(MediaType.MULTIPART_FORM_DATA_VALUE);
        response.setCharacterEncoding(ThreshConstant.UTF8);
    ...
    private static String getFileType(File file) throws Exception {
        ...
        return fileName.substring(fileName.lastIndexOf(StringConstant.DOT) + 1);
    }
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(ThreshConstant.VALID_FILE_TYPE, fileType);
    }
