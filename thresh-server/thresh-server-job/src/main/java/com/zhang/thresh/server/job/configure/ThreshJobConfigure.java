package com.zhang.thresh.server.job.configure;
...
public class ThreshJobConfigure {
    ...
    public ThreadPoolTaskExecutor scheduleJobExecutorService() {
        ...
        executor.setThreadNamePrefix("Thresh-Job-Thread");
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "ThreshCloudScheduler");
        ...
        factory.setSchedulerName("Thresh_Cloud_Scheduler");
        // 延时启动
