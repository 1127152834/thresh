package com.zhang.thresh.server.system.utils;
...
/**
 * https://blog.csdn.net/lihaoyiding/article/details/108726039
 * 根据 IP获取地址
 *
 * @author MrZhang
 */
...
public abstract class AddressUtil {
    ...
    public static String getCityInfo(String ip) {
        ...
        try {
            ...
            if (!file.exists()) {
                String tmpDir = System.getProperties().getProperty(ThreshConstant.JAVA_TEMP_DIR);
                dbPath = tmpDir + "ip.db";
