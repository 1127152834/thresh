...
import com.zhang.thresh.common.core.entity.MenuTree;
...
import com.zhang.thresh.common.core.entity.router.RouterMeta;
...
import com.zhang.thresh.server.system.mapper.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    private void checkUser(String username) {
        ...
        if (StringUtils.isNotBlank(currentUsername)
            ...
            throw new ThreshException("无权获取别的用户数据");
        }
    }
